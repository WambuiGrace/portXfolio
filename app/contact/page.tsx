...
import QRCodeComponent from "@/components/qr-code" // Update this import
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:wambuigm55@gmail.com"
                        className="text-muted-foreground hover:text-primary transition-colors"
                      >
                        wambuigm55@gmail.com
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Thika, Kiambu Kenya</p>
                    </div>
                  </div>
                </div>

                <div className="mt-8">
                  <h3 className="text-lg font-medium mb-4">Scan to connect</h3>
                  <QRCodeComponent />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://github.com/WambuiGrace"
                  ...
                  <a
                    href="https://www.linkedin.com/in/grace-mwangi-4201a4240/"
                    className="p-2 bg-muted rounded-full hover:bg-primary hover:text-primary-foreground transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a
                    href="https://x.com/_wambui254_?s=21"
                    className="p-2 bg-muted rounded-full hover:bg-primary hover:text-primary-foreground transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
